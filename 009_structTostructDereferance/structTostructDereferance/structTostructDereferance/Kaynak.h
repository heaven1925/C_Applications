...
#define	SX1276_REG_SYNCVALUE3												( SX1276_REG_SYNCVALUE2 + 0x01 )
#define	SX1276_REG_SYNCVALUE4												( SX1276_REG_SYNCVALUE3 + 0x01 )
#define	SX1276_REG_SYNCVALUE5												( SX1276_REG_SYNCVALUE4 + 0x01 )	
#define	SX1276_REG_SYNCVALUE6												( SX1276_REG_SYNCVALUE5 + 0x01 )
#define	SX1276_REG_SYNCVALUE7												( SX1276_REG_SYNCVALUE6 + 0x01 )
#define	SX1276_REG_SYNCVALUE8												( SX1276_REG_SYNCVALUE7 + 0x01 )
...
#define RF_SYNCVALUE8_SYNCVALUE                     0x01  // Default
...
#if 1 //@INFO: SX1262 Register Configuration numaratörleri 	//@NEW aertekin
	...
	//@INFO: Kullanilan güc regülatörü numaratörü
	typedef enum
	{
	...
	//@INFO: Kullanulanbilecek paket-protokol tipleri numaratörü
	typedef enum
	{
	...
	//@INFO: Güç yükseltecinin Ramping(Yükselme) zamani numaratörü 
	typedef enum
	{																											/* ramp time [us]	*/
...
#define	RADIO_OUTPUTPOWER_14DBM		\
	...
	//@INFO: LoRa kullanilan aktif kanal numaratörü
	typedef enum
	{
	...
	//@INFO: LoRa CAD islemi tamamlandiktan sonra Kanal Etkinligi Algilama numaratörü
	typedef enum
	{
		LORA_CAD_ONLY = 0x00,
		LORA_CAD_RX = 0x01,
	...
	//@INFO: Modülasyon türü belirleme numaratörü
	typedef enum
	{
...
#define	WMBUS_
	...
	//@INFO: Modülasyon band genisligi numaratörü 		
	typedef enum
	{
		RX_BW_4800 = 0x1F,
		RX_BW_5800 = 0x17,
	...
	//@INFO:Lora Paket türleri için saçilma faktörü numaratörüleri	
	typedef enum
	{
		LORA_SF5 = 0x05,
		LORA_SF6 = 0x06,
	...
	//@INFO: LoRa paket türü için bant genisligi numaratörü
	typedef enum
	{
		LORA_BW_500 = 6,
		LORA_BW_250 = 5,
	...
	//@INFO: LoRa paket türü için kodlama hizi degerleri numaratorleri
	typedef enum
	{
		LORA_CR_4_5 = 0x01,
		LORA_CR_4_6 = 0x02,
	...
	//@INFO: RX tarafindan gelen bit uzunlugu tespit numaratörler
	typedef enum
	{
	...
	//@INFO: Radio whitening mode durum numaratörü
	typedef enum
	{
	...
	//@INFO: LoRA paketi için CRC durum numaratörü
	typedef enum
	{
	...
	//@INFO: Radio komutlari icin mevcut olan interrupt maskeleme numaratörleri
	//@INFO: Tüm paket türleri için bu interruptlar gecerlidir !
...
/***********************************************************************************************/
	typedef struct {		//@ASK: MEFE'ye danisilacak !!
...
#define		SETSLEEP_CMD_SIZE			2
	...
	typedef union RadioStatus_u
	{
		...
		{   //@INFO: Bit yerlesimi lsb -> msb seklindedir.
			...
			uint8_t ChipMode : 3;  //@INFO: Çip Modu - Chip mode
			uint8_t : 1;  //!< Reserved
		}Fields;
	}RadioStatus_t;
	/*******************************************************************************/
	...
	/*******************************************************************************/
	//@INFO: Paket türleri icin modülasyon parametrelerinin belirtildigi yapi
	typedef struct
	{
		RadioPacketTypes_t     PacketType;      //@INFO: Modülasyon yapilacak paket türü Lora/GFSK/None
		struct
		{
			struct	//@INFO: GFSK Modülasyon Parametreleri
			{
				uint32_t                     										BitRate;
				uint32_t                     										Fdev;
			...
			struct	//@INFO: LoRa Modülasyon Parametreleri
			{
		...
		}Params;  //@INFO: Modülasyon Parametrelerini Tutan yapi
	}ModulationParams_t;
	/*******************************************************************************/
	...
	@NOTICE: Whitening, rastgele bir dizi olusturmak için kullanilan bir yapidir.
	...
	*******************************************************************************/
	typedef struct
	{
		RadioPacketTypes_t       						 PacketType;        //@INFO: Paket icerigi belirtilecek paket türü Lora/GFSK/None
		struct
		{
			struct	//@INFO: GFSK Paket Parametreleri
			{
			...
			struct //@INFO: LoRA Paket Parametreleri
			{
	...
	typedef struct
	{
		RadioPacketTypes_t  									packetType;   	//@INFO: Paket durumu gözlemlenecek, paket türü
		struct
		{
			struct	//@INFO: GFSK Paket Durumlari
			{
				uint8_t 																					RxStatus;
			...
			struct	//@INFO: LoRA Paket Durumlari
			{
...
#if 1 //@INFO: Paket Türlerine göre özel konfigürasyon yapilari
...
//@INFO:  GFSK or LoRa paket tipi kullanildigin alinan paket sayisinin hatali-paket , crc-hatasi ve alinan paketlerin tutuldugu yapi
	...
	//@INFO:  Kalibrasyon konfigürasyonlarinin tutuldugu yapi
	typedef union
	{
		struct
		{
	...
	//@INFO: Olusabilecek hata türlerinin tutuldugu yapi
	typedef union
	{
		struct
		{
...
{ 500000, 0x00 }, // Invalid Bandwidth
...
#if 1 //@INFO: Radio Interruptlarinin donus fonksiyon pointer yapisi
	...
	typedef struct
	{
		...
		//void ( *rxHeaderDone )( bool isOk );    //@BACK      									//!< Pointer to a function run on successful Header reception
	   ...
	   // void ( *cadDone )( bool cadFlag );     //@BACK        								//!< Pointer to a function run on channel activity detected
	}SX126xCallbacks_t;
#endif

#if 1	//@INFO: SX1262 Main Structures	
	//@INFO: SX1262 için pin yapisi
...
#define BOARD_TCXO_WAKEUP_TIME						5
	...
	//@INFO: StandBy modunda kullanilan OSC tipi numaratörleri
	typedef enum {
		STDBY_RC = 0x00,
		STDBY_XOSC = 0x01,
	}RadioStandbyModes_t;

	//@INFO:  Uyku modu konfigürasyonlarinin tutuldugu yapi
	typedef union {
		struct
		{
	...
	typedef struct
	{
		...
		ModulationParams_t 						ModulationParams;		//@INFO: Modülasyon Parametrelerini Tutan yapi			
	}SX126x_t;
